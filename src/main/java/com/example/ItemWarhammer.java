...
public class ItemWarhammer extends ItemWeaponBase
{
	...
	{
		super(unlocName, material, ConfigHandler.damageBaseWarhammer, ConfigHandler.damageMultiplierWarhammer, ConfigHandler.speedWarhammer, WeaponProperties.ARMOUR_PIERCING_50,
				WeaponProperties.REACH_1, WeaponProperties.TWO_HANDED_1);
